...
namespace ML.NetConsoleDemo.Session_13
{
	internal class Demo
	{
		public static void Execute()
		{
			...
			var crossValidationResult = context.Regression.CrossValidate(traningData, pipeline, numberOfFolds: 5, labelColumnName: nameof(InputModel.Salary));

			var allMetrics = crossValidationResult.Select(r => r.Metrics);
			var allModels = crossValidationResult.Select(r => r.Model);
