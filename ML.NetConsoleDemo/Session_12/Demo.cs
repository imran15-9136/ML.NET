...
namespace ML.NetConsoleDemo.Session_12
{
	internal class Demo
	{
		public static void Execute()
		{
			...
			var split = context.Data.TrainTestSplit(traningData, testFraction:0.2);

			var model = pipeline.Fit(split.TrainSet);

			var metrics = context.Regression.Evaluate(model.Transform(split.TestSet), labelColumnName: nameof(InputModel.Salary));
